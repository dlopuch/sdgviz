/**
 * Normal build creates an unminified bundle with sourcemap.
 *
 * To make a production build, run webpack as:
 *   NODE_ENV=production webpack --optimize-minimize --devtool none
 */
